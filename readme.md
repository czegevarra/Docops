...
NO There are two disturbing facts about Perl you should know.  
YES You should know two disturbing facts about Perl.  

Часто there is are ставят, если нет субъекта, тогда добавьте его  
NO There is no guarantee that the updates will be received in sequential order.  
YES Clients might not receive the updates in sequential order.  
...
For example, the key message in the following sentence is that Python is an interpreted language; the sentence can survive without Guido van Rossum invented:  
...
+ Выбрать исполнителя: No Set assignee,Yes Assign user
+ A document with this name already exists.
Articles
Don't use in the beginning of the message:

“Object ​{{bimExemplarGlobalId}}​ has an invalid «Related objects» link.”
Но THE ​{{bimExemplarGlobalId}} ...
Use in the middle:
“Linking a 3D object to an object”,

“Invalid value of the property ​{{propertyName}}​ in the object ​{{bimExemplarGlobalId}}​ ​{{bimExemplarTitle}}​”
